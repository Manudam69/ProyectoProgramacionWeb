...
<html>
    ...
    %>
    <%
        Cookie galletafondo = new Cookie(name + "Fondo", "#04043d");//Establese la galleta y su valor, en este caso:
        ...
        Cookie galletafondo2 = new Cookie(name + "Letra", "#5e9b98");//Lo mismo pero para el color de las letras
